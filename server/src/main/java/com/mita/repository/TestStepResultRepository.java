...
public interface TestStepResultRepository extends JpaRepository<TestStepResult, Long> {
  ...
  @Query("SELECT " +
    "MAX(" +
    " CASE " +
    "   WHEN stepResult.result = com.mita.model.ResultConstant.SUCCESS THEN 0 " +
    "   WHEN stepResult.result = com.mita.model.ResultConstant.FAILURE THEN 1 " +
    "   WHEN stepResult.result = com.mita.model.ResultConstant.ABORTED THEN 2 " +
    "   WHEN stepResult.result = com.mita.model.ResultConstant.NOT_EXECUTED THEN 3 " +
    "   WHEN stepResult.result = com.mita.model.ResultConstant.QUEUED THEN 4 " +
    "   ELSE 5 " +
