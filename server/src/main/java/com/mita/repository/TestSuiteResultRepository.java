...
public interface TestSuiteResultRepository extends JpaRepository<TestSuiteResult, Long> {
  ...
  @Query("SELECT " +
    "MAX(" +
    " CASE " +
    "   WHEN suiteResult.result = com.mita.model.ResultConstant.SUCCESS THEN 0 " +
    "   WHEN suiteResult.result = com.mita.model.ResultConstant.FAILURE THEN 1 " +
    "   WHEN suiteResult.result = com.mita.model.ResultConstant.ABORTED THEN 2 " +
    "   WHEN suiteResult.result = com.mita.model.ResultConstant.NOT_EXECUTED THEN 3 " +
    "   WHEN suiteResult.result = com.mita.model.ResultConstant.QUEUED THEN 4 " +
    "   ELSE 5 " +
