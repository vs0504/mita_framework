...
public interface TestCaseResultRepository extends JpaRepository<TestCaseResult, Long> {
  ...
  @Query("SELECT " +
    "MAX(" +
    " CASE " +
    "   WHEN caseResult.result = com.mita.model.ResultConstant.SUCCESS THEN 0 " +
    "   WHEN caseResult.result = com.mita.model.ResultConstant.FAILURE THEN 1 " +
    "   WHEN caseResult.result = com.mita.model.ResultConstant.ABORTED THEN 2 " +
    "   WHEN caseResult.result = com.mita.model.ResultConstant.NOT_EXECUTED THEN 3 " +
    "   WHEN caseResult.result = com.mita.model.ResultConstant.QUEUED THEN 4 " +
    "   ELSE 5 " +
