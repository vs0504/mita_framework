...
public class StepProcessor {
  ...
  public StepProcessor(WebApplicationContext webApplicationContext, List<TestCaseStepEntityDTO> testCaseStepEntityDTOS,
                       ...
                       TestStepDTO testStepDTO, Long testPlanId, com.mita.model.TestDataSet testDataSet,
  ...
  public TestCaseStepEntityDTO processStep() throws TestsigmaException {
    ...
    if ((testStepDTO.getType() != null &&
      (testStepDTO.getType() == TestStepType.STEP_GROUP)
      || (testStepDTO.getType() == TestStepType.FOR_LOOP))) {
  ...
  public void setTestDataMap(TestCaseStepEntityDTO exeTestStepEntity) throws TestsigmaException {
    ...
    if (testStepDTO.getAddonActionId() != null || testStepDTO.getAddonTestData() != null) {
      ...
      for (Map.Entry<String, AddonTestStepTestData> entry : testDataMap.entrySet()) {
        ...
        TestDataPropertiesEntity testDataPropertiesEntity = getTestDataEntityDTO(testDataName,
  ...
  public com.mita.model.TestDataSet getTestDataIdFromStep(TestCaseStepEntityDTO step) throws ResourceNotFoundException {
    try {
  ...
  public String populateTestDataParameter(com.mita.model.TestDataSet testDataSet, TestCaseStepEntityDTO exeTestStepEntity,
                                          String testDataValue, TestDataPropertiesEntity testDataPropertiesEntity) throws ResourceNotFoundException {
    ...
    if (((testDataSet == null) || (testDataSet.getData() == null))) {
      if(!isParentStepExists)
        throw new ResourceNotFoundException(MessageConstants.getMessage(MessageConstants.MSG_UNKNOWN_TEST_DATA_SET));
      else{
