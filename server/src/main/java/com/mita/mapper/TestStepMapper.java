...
import com.mita.dto.export.TestStepXMLDTO;
...
//  @Mapping(target = "testDataFunction", expression = "java(this.mapTestDataFunction(testStepDataMap.getTestDataFunction()))")
  ...
  @Mapping(target = "responseCompareType", expression = "java(org.apache.commons.lang3.ObjectUtils.defaultIfNull(restStepDTO.getResponseCompareType(), com.mita.model.RestStepCompareType.LENIENT).name())")
  @Mapping(target = "headerCompareType", expression = "java(org.apache.commons.lang3.ObjectUtils.defaultIfNull(restStepDTO.getHeaderCompareType(), com.mita.model.RestStepCompareType.LENIENT).name())")
  ...
  @Mapping(target = "authorizationType", expression = "java(org.apache.commons.lang3.ObjectUtils.defaultIfNull(restStepDTO.getAuthorizationType(), com.mita.model.RestStepAuthorizationType.NONE).ordinal())")
