...
public class TestCasesRecorderController {
    ...
    public Page<com.mita.model.recorder.TestCaseDTO> index(TestCaseSpecificationsBuilder builder,
        ...
        List<com.mita.model.recorder.TestCaseDTO> results = testDataMapper.mapTestCaseDTOs(testCaseDTOS);
