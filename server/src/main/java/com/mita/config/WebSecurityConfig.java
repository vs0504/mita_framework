...
import com.mita.security.*;
import com.mita.security.api.APIAuthenticationFilter;
import com.mita.security.api.AgentJwtAuthenticationFilter;
import com.mita.security.api.RestAuthenticationEntryPoint;
import com.mita.service.AuthUserService;
import com.mita.service.JWTTokenService;
import com.mita.security.AjaxLoginFailureHandler;
import com.mita.security.AjaxLoginSuccessHandler;
import com.mita.security.JWTAuthenticationFilter;
...
import static com.mita.config.AjaxLoginFormConfigurer.ajaxLogin;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  @Bean
  public APIAuthenticationFilter apiJwtAuthenticationFilter() throws Exception {
  ...
  @Bean
  public PresignedAuthenticationFilter presignedJwtAuthenticationFilter() throws Exception {
    PresignedAuthenticationFilter filter = new PresignedAuthenticationFilter();
    filter.setAuthenticationManager(super.authenticationManagerBean());
    return filter;
  }
