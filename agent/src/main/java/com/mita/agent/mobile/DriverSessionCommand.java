...
import com.mita.agent.exception.MobileAutomationServerCommandExecutionException;
import com.mita.agent.request.TapPoint;
import com.mita.automator.actions.mobile.*;
import com.mita.automator.actions.mobile.android.generic.ChangeScreenOrientationAction;
import com.mita.automator.actions.mobile.android.generic.GetScreenOrientationAction;
import com.mita.automator.actions.mobile.android.generic.GoToHomeScreenAction;
import com.mita.automator.entity.Platform;
import com.mita.automator.entity.TestDataPropertiesEntity;
import com.mita.agent.dto.ScreenDimensions;
import com.mita.automator.constants.NaturalTextActionConstants;
import com.mita.automator.constants.ActionResult;
import com.mita.automator.entity.ElementPropertiesEntity;
import com.mita.automator.actions.ElementSearchCriteria;
import com.mita.automator.actions.FindByType;
import com.mita.automator.actions.mobile.android.switchactions.SwitchToContextWithNameAction;
import com.mita.automator.actions.mobile.android.switchactions.SwitchToNativeAppContextAction;
...
public class DriverSessionCommand {
  ...
  public void tap(String sessionId, TapPoint tapPoint) throws MobileAutomationServerCommandExecutionException {
    try {
      ...
      tapPointAction.setTapPoint(new com.mita.automator.actions.mobile.TapPoint(tapPoint.getX(),
        tapPoint.getY()));
  ...
  public void swipe(String sessionId, List<TapPoint> tapPoints) throws MobileAutomationServerCommandExecutionException {
    try {
      RemoteWebDriver remoteWebDriver = sessionContainer.getSessionMap().get(sessionId);
      SwipeAction swipeAction = new SwipeAction();
      List<com.mita.automator.actions.mobile.TapPoint> targetTapPoints = new ArrayList<>();
      for (TapPoint tapPoint : tapPoints) {
        targetTapPoints.add(new com.mita.automator.actions.mobile.TapPoint(tapPoint.getX(), tapPoint.getY()));
      }
      swipeAction.setTapPoints(targetTapPoints.toArray(new com.mita.automator.actions.mobile.TapPoint[2]));
  ...
  public void goToHome(String sessionId) throws Exception {
    ...
    if (remoteWebDriver.getClass().equals(AndroidDriver.class)) {
      GoToHomeScreenAction homeScreenAction = new GoToHomeScreenAction();
      homeScreenAction.setDriver(remoteWebDriver);
      homeScreenAction.execute();
    } else {
      com.mita.automator.actions.mobile.ios.generic.GoToHomeScreenAction homeScreenAction = new com.mita.automator.actions.mobile.ios.generic.GoToHomeScreenAction();
      homeScreenAction.setDriver(remoteWebDriver);
      homeScreenAction.execute();
    }
  }
  ...
  public void changeOrientation(String sessionId) throws Exception {
    RemoteWebDriver remoteWebDriver = sessionContainer.getSessionMap().get(sessionId);
    if (remoteWebDriver.getClass().equals(AndroidDriver.class)) {
      ChangeScreenOrientationAction changeScreenOrientationAction = new ChangeScreenOrientationAction();
      changeScreenOrientationAction.setDriver(remoteWebDriver);
      changeScreenOrientationAction.execute();
    } else {
      com.mita.automator.actions.mobile.ios.generic.ChangeScreenOrientationAction changeScreenOrientationAction = new com.mita.automator.actions.mobile.ios.generic.ChangeScreenOrientationAction();
      changeScreenOrientationAction.setDriver(remoteWebDriver);
      changeScreenOrientationAction.execute();
    }
  }
  ...
  public ScreenOrientation getOrientation(String sessionId) throws Exception {
    ...
    if (remoteWebDriver.getClass().equals(AndroidDriver.class)) {
      GetScreenOrientationAction getScreenOrientationAction = new GetScreenOrientationAction();
      ...
      com.mita.automator.actions.mobile.ios.generic.GetScreenOrientationAction getScreenOrientationAction = new com.mita.automator.actions.mobile.ios.generic.GetScreenOrientationAction();
      getScreenOrientationAction.setDriver(remoteWebDriver);
      getScreenOrientationAction.execute();
      orientation = (ScreenOrientation) getScreenOrientationAction.getActualValue();
    }
