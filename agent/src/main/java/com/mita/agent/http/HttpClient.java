...
@Log4j2
public class HttpClient extends com.mita.automator.http.HttpClient {
  ...
  public <T> com.mita.automator.http.HttpResponse<T> get(String url, TypeReference<T> typeReference)
    throws IOException {
    return get(url, typeReference, null);
  }

  public <T> com.mita.automator.http.HttpResponse<T> put(String url, Object data,
                                                         TypeReference<T> typeReference)
    throws IOException {
    return put(url, data, typeReference, null);
  }

  public <T> com.mita.automator.http.HttpResponse<T> post(String url, Object data,
                                                          TypeReference<T> typeReference)
    throws IOException {
    return post(url, data, typeReference, null);
  }

  public <T> com.mita.automator.http.HttpResponse<T> downloadFile(String url, String filePath) throws IOException {
  ...
  public <T> com.mita.automator.http.HttpResponse<T> get(String url, TypeReference<T> typeReference,
    ...
    try {
      ...
      return new com.mita.automator.http.HttpResponse<T>(res, typeReference);
    } finally {
      if (client != null) {
  ...
  public <T> com.mita.automator.http.HttpResponse<T> downloadFile(String url, String filePath, String authHeader) throws IOException {
    ...
    try {
      ...
      return new com.mita.automator.http.HttpResponse<T>(res);
    } finally {
      if (client != null) {
        HttpClientUtils.closeQuietly(client);
      }
