...
import com.mita.agent.dto.ExecutionDTO;
import com.mita.agent.tasks.TestPlanRunTask;
import com.mita.agent.http.HttpClient;
  ...
  public void run() {
    try {
      ...
      if (response.getStatusCode() == HttpStatus.OK.value()) {
        ...
        log.error("Unable To Fetch Executions From Mita Servers. Request Failed With Response Code - "
