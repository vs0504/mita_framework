...
export class UrlConstantsService {
  ...
  public loginUrl = this.apiBase + '/login' ;
  public logoutUrl = this.apiBase + '/logout' ;
  ...
  public sendTestPlanResultURL = this.apiBase+"/test_plan_results/testPlanResultSendMail"
