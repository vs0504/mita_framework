...
public class AutomatorMessages {
  ...
  final public static String INVALID_NUMBER_ARGUMENT = "Invalid integer provided to generate random test data string.";
//  Refer \"https://testsigma.com/docs/test-data/types/random/\" to know the valid integer range and learn more about random test data";
