...
package com.mita.automator.actions;
...
import com.mita.automator.entity.AttributePropertiesEntity;
...
public abstract class ElementAction extends DriverAction {
  ...
  protected By getBy() throws AutomatorException {
    return getBy(NaturalTextActionConstants.TESTS_TEP_DATA_MAP_KEY_ELEMENT);
  }
  ...
  protected void findElement() throws Exception {
    findElement(NaturalTextActionConstants.TESTS_TEP_DATA_MAP_KEY_ELEMENT);
  }

  protected String getTestData() {
    return getTestData(NaturalTextActionConstants.TEST_STEP_DATA_MAP_KEY_TEST_DATA);
  }
  ...
  protected FindByType getFindByType() {
    return getFindByType(NaturalTextActionConstants.TESTS_TEP_DATA_MAP_KEY_ELEMENT);
  }
  ...
  protected String getLocatorValue() {
    return getLocatorValue(NaturalTextActionConstants.TESTS_TEP_DATA_MAP_KEY_ELEMENT);
  }
  ...
  protected String getAttribute() {
    return getAttribute(NaturalTextActionConstants.TEST_STEP_DATA_MAP_KEY_ATTRIBUTE);
  }
  ...
  protected void constructElementWithDynamicXpath(String dynamicXpath) throws AutomatorException {
    constructElementWithDynamicXpath(dynamicXpath, NaturalTextActionConstants.TESTS_TEP_DATA_MAP_KEY_ELEMENT, NaturalTextActionConstants.TEST_STEP_DATA_MAP_KEY_TEST_DATA,
      NaturalTextActionConstants.TEST_STEP_DATA_MAP_KEY_ATTRIBUTE, false);
  }
  ...
  protected void constructElementWithDynamicXpath(String parameterizedXpath, String elementActionVarName, String testDataActionVarName,
    ...
    if (isAttributeToBeReplacedWith && attributeActionVariableName != null) {
      ...
      xpath = parameterizedXpath.replace(NaturalTextActionConstants.PARAMETERIZED_XPATH_PLACE_HOLDER, getAttribute(attributeActionVariableName));
      ...
      xpath = parameterizedXpath.replace(NaturalTextActionConstants.PARAMETERIZED_XPATH_PLACE_HOLDER, getTestData(testDataActionVarName));
    }
