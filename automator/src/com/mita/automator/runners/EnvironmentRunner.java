...
import com.mita.automator.constants.*;
import com.mita.automator.entity.*;
import com.mita.automator.exceptions.AutomatorException;
import com.mita.automator.exceptions.TestsigmaNoParallelRunException;
import com.mita.automator.http.HttpClient;
import com.mita.automator.utilities.ErrorUtil;
import com.mita.automator.utilities.PathUtil;
import com.mita.automator.utilities.ScreenCaptureUtil;
import com.mita.automator.constants.ExecutionStatus;
import com.mita.automator.constants.AutomatorMessages;
import com.mita.automator.drivers.DriversUpdateService;
import lombok.Data;
...
public abstract class EnvironmentRunner {
  ...
  protected void setEnvironmentResult() {
    if (!isRunning()) {
      ...
      environmentRunResult.setErrorCode(ErrorCodes.USER_STOPPED_EXECUTION);
    } else {
