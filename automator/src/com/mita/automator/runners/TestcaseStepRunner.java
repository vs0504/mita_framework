...
import com.mita.automator.service.AddonService;
import com.mita.automator.service.ObjectMapperService;
import com.mita.automator.utilities.RuntimeDataProvider;
import com.mita.automator.utilities.ScreenCaptureUtil;
import com.mita.automator.constants.EnvSettingsConstants;
...
public abstract class TestcaseStepRunner {
  ...
  public TestCaseStepResult run(TestCaseStepEntity testCaseStepEntity, TestCaseStepResult testCaseStepResult,
    ...
    try {
      ...
      status = ResultConstant.FAILURE;
      testCaseStepResult.setErrorCode(ErrorCodes.BROWSER_CLOSED);
