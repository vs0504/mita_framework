package com.mita.automator.webservices;
...
import com.mita.automator.constants.AuthorizationTypes;
import com.mita.automator.constants.AutomatorMessages;
import com.mita.automator.exceptions.AutomatorException;
import com.mita.automator.exceptions.TestsigmaFileNotFoundException;
import com.mita.automator.exceptions.TestsigmaTestdataNotFoundException;
import com.mita.automator.runners.EnvironmentRunner;
import com.mita.automator.service.ObjectMapperService;
    ...
    if (entity.getAuthorizationType() != null) {
      ...
      if (AuthorizationTypes.BASIC == entity.getAuthorizationType()) {
        headers.put(HttpHeaders.AUTHORIZATION,
          com.mita.automator.http.HttpClient.BASIC_AUTHORIZATION + " " +
  ...
  private String downloadFile(String fileUrl, Map<String, String> envSettings) throws Exception {
    try {
      if (fileUrl.startsWith(HTTP) || fileUrl.startsWith(HTTPS)) {
        ...
        com.mita.automator.http.HttpClient httpClient = EnvironmentRunner.getAssetsHttpClient();
